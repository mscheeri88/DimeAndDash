...
VALUES	('Coors Light','Alcoholic Beverages',3,12,1001,10001),
		('Wings','Food',6.5,10,1001,10001),
		('Green Bean Fries','Food',4.5,10,1001,10002),
        ('Steak','Food',8.5,10,1001,10002),
        ('Coke','Beverages',2,10,1001,10002),
        ('Ice Cream','Dessert',3,10,1001,10001),
        ('Brownie Obession','Dessert',5,10,1001,10002),
        ('Coors Light','Alcoholic Beverages',3,12,1001,10001),
        ('Coors Light','Alcoholic Beverages',3,12,1001,10002),
        ('Green Bean Fries','Food',4.5,10,1001,10002),
        ...
        ('Bud Light','Alcoholic Beverages',2,12,1005,10009),
        ('Bud Light','Alcoholic Beverages',2,12,1005,10009),
        ('Jack Daniel Chicken','Food',6.5,10,1005,10009);
