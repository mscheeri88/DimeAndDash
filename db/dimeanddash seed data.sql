...
VALUES	('Coors Light','Alcoholic Beverages',3,12,1001,0),
		('Wings','Food',6.5,10,1001,0),
		('Green Bean Fries','Food',4.5,10,1001,0),
        ('Steak','Food',8.5,10,1001,0),
        ('Coke','Beverages',2,10,1001,0),
        ('Ice Cream','Dessert',3,10,1001,0),
        ('Brownie Obession','Dessert',5,10,1001,0),
        ('Coors Light','Alcoholic Beverages',3,12,1001,0),
        ('Coors Light','Alcoholic Beverages',3,12,1001,0),
        ('Green Bean Fries','Food',4.5,10,1001,0),
